...
let locationArray:string[]=["Turkey","Italy","Finland","Maldives","Switzerland"]
console.log("Original Array: ", locationArray)
let sortedLocationArray:string[]=locationArray.slice().sort()
console.log("Sorted Array: ",sortedLocationArray)
console.log("Original Array: ", locationArray)
let reverseSortedLocationArray:string[]=locationArray.slice().sort((a,b)=>b.localeCompare(a))
